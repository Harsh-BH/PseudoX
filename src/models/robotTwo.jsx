...
const RobotTwo=(props) =>{
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/toy_robot_animated_-_lowpoly.glb')
...
useGLTF.preload('/toy_robot_animated_-_lowpoly.glb')
