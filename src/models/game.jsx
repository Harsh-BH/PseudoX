...
const Drone=(props)=> {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/pearl_drone_-_splatoon_side_order_trailer.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]} scale={1.134}>
          <group
              ...
              <group name="RootNode">
                ...
                <group
                  ...
                  <group name="Object_13">
                    ...
                    />
                    <group name="Object_15" position={[-1.328, 19.394, 0]} scale={100} />
                    <group name="Circle" position={[0, 0, 0.167]} rotation={[Math.PI / 2, 0, 0]}>
                      <mesh
                      ...
                      <group name="Circle002" position={[-1.328, 19.394, 0]} scale={100} />
...
useGLTF.preload('/pearl_drone_-_splatoon_side_order_trailer.glb')
